...
export declare class Registry {
    ...
    defineHook(keyword: HookKeyword, options: {
        tags?: string;
    }, fn: IHookBody): void;
    ...
    defineStepHook(keyword: HookKeyword, options: {
        tags?: string;
